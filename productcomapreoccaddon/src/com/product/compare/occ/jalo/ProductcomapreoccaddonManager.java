 ...
 */
package com.product.compare.occ.jalo;
...
import com.product.compare.occ.constants.ProductcomapreoccaddonConstants;



/**
 * This is the extension manager of the productcomapreoccaddon extension.
 */
public class ProductcomapreoccaddonManager extends GeneratedProductcomapreoccaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(ProductcomapreoccaddonManager.class.getName());
	 ...
	 */
	public ProductcomapreoccaddonManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ProductcomapreoccaddonManager called.");
		}
	}
	 ...
	 */
	public static ProductcomapreoccaddonManager getInstance()
	{
		return (ProductcomapreoccaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(ProductcomapreoccaddonConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ProductcomapreoccaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ProductcomapreoccaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
