 ...
 */
package com.product.compare.jalo;
...
import com.product.compare.constants.ProductcomapreaddonConstants;



/**
 * This is the extension manager of the Productcomapreaddon extension.
 */
public class ProductcomapreaddonManager extends GeneratedProductcomapreaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(ProductcomapreaddonManager.class.getName());
	 ...
	 */
	public static ProductcomapreaddonManager getInstance()
	{
		return (ProductcomapreaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ProductcomapreaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ProductcomapreaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ProductcomapreaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ProductcomapreaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ProductcomapreaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
